...
import { markNeedsFix } from "@/lib/task-service";
import { serializeTask } from "@/lib/serialize";
import { apiNeedsFixSchema } from "@/lib/validation";
...
export async function POST(
  ...
  const parsed = apiNeedsFixSchema.safeParse(body);
  if (!parsed.success) {
